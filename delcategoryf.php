                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td align='center'><img src='img/".$row["Pic"]."' width='50%' height='150px'></td>";
                                            echo "<td><a href='delcatf.php?ID=$row[0]' onclick=\"return confirm('คุณแน่ใจแล้วหรอที่จะลบ !!!')\" class='btn btn-outline-danger'>ลบ</href=></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
