...
<head>
  ...
  <link rel="alternate" href="android-app://com.grabtaxi.passenger/https/food.grab.com/th/th/restaurants?utm_source=food-grab-com&amp;sourceID=food-grab-com&amp;utm_campaign=GF-WEB-TH-restaurants-appindex" class="next-head">
  <link rel="alternate" href="ios-app://647268330/https/food.grab.com/th/th/restaurants?utm_source=food-grab-com&amp;sourceID=food-grab-com&amp;utm_campaign=GF-WEB-TH-restaurants-appindex" class="next-head">
            ...
            <div class="sectionContent___2XGJB">
              <div class="breadcrumb___5JopJ ant-breadcrumb"><span><span class="link___2bcrF"><a href="https://food.grab.com/th/th/">บ้าน</a></span><span class="ant-breadcrumb-separator">
                  ...
                  <?php
                    include("server.php");
                    $id = $_REQUEST["ID"];
                    $sql= "SELECT * from categoryf WHERE ID_CATF='$id'";
                    $result = mysqli_query($con, $sql);
                    $row = mysqli_fetch_array($result);
      echo   '     <div class="ant-layout">
              <h1 class="title___dCI3A"><span class="textPrefix___8VBSV">หมวดหมู่ <strong>'.$row["CATF_Name"].'</strong></span></h1>
              <div class="ant-layout">
                <div>
                  <div class="ant-row-flex RestaurantListRow___1SbZY">';        
                     $sql1= "SELECT * from foodstock WHERE ID_CATF='$id'";
                     $result1 = mysqli_query($con, $sql1);
                     while($row1 = mysqli_fetch_array($result1)){
            echo   "<div class='ant-col-24 RestaurantListCol___1FZ8V  ant-col-md-12 ant-col-lg-6'><a href='buyfood.php?ID_Shop=$row1[5]' style='color: inherit; text-decoration: none;'>";
                 echo '       <div class="ant-row-flex ant-row-flex-start ant-row-flex-top asList___1ZNTr">
                          <div class="ant-col-24 colPhoto___3vb-o ant-col-md-24 ant-col-lg-24">
                            <div class="promoTag___IYhfm">
                              <div class="placeholder___1xbBh restoPhoto___3nncy"><img class="realImage___2TyNE show___3oA6B" src="img/shop/'.$row1["PicFood"] .'"></div>
                          ...
                          <div class="ant-col-24 colInfo___3iLqj ant-col-md-24 ant-col-lg-24">
                            <h6 class="name___2epcT">'.$row1["Food_Name"] .'</h6>
