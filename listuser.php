                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td>" . $row["BDate_User"] . "</td>";
                                            echo "<td><a href='listuser_edit.php?ID=$row[0]'  class='btn btn-outline-primary'>แก้ไข</a> <a href='delfood.php?ID=$row[0]' onclick=\"return confirm('คุณแน่ใจแล้วหรอที่จะลบ !!!')\" class='btn btn-outline-danger'>ลบ</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
