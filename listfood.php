                ...
                <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="bi bi-egg-fried"></i><span> อาหาร</span><i class="icon-arrow-down"></i></a>
                    <ul class="active treeview-menu">
                        <li class="treeview active">
                            ...
                            <ul class="active treeview-menu">
                                <li class="active">
                                    <a class="waves-effect waves-dark active" href="listfood.php">
                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td><a href='delfood.php?ID=$row[0]' onclick=\"return confirm('คุณแน่ใจแล้วหรอที่จะลบ !!!')\" class='btn btn-outline-danger'>ลบ</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
