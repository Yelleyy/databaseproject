...
$ID_Shop = $_REQUEST["ID"];
$sql2 = "SELECT * FROM Shop WHERE ID_Shop = '$ID_Shop'";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                    <form action='listshop_update.php?ID=<?php echo "$ID_Shop";?>' method="post" enctype="multipart/form-data">

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>ชื่อร้านค้า</label>
                                                <input type="text" id="Name_Shop" name="Name_Shop"class="form-control" value=<?php echo $row2['Name_Shop'];?> >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>อีเมลล์ร้านค้า</label>
                                                <input type="text" id="Email_Shop" name="Email_Shop" class="form-control" value=<?php echo $row2['Email_Shop'];?>>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>รหัสผ่าน</label>
                                                <input type="text" id="Pass_Shop" name="Pass_Shop" class="form-control" value=<?php echo $row2['Pass_Shop'];?>>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>เบอร์โทร</label>
                                                <input type="text" id="Tel_Shop" name="Tel_Shop" class="form-control" value=<?php echo $row2['Tel_Shop'];?>>
                                            </div>
