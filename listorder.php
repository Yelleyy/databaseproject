            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="main-header">คลังสินค้า</h4>
                  </div>
                  <div class="card-body">
                        ...
                        <table id="example" class="display" style="min-width: 845px">
                           ...
                           <tbody>
                              ...
                              while ($row = mysqli_fetch_array($result)) {
                                 ...
                                 echo "<td  align='center' >" . "<a href='listdetail.php?ID=$row[0]' >"
                                 ...
                                 echo "<td align='center'>";
                                 if ($row["status"] == "work") {
                                    echo "<a href='changecusshopadmin.php?ID_Order=$row[0]' onclick=\"return confirm('ยืนยันการยอมรับ... !!!')\" 
                                  class='btn btn-success mt-1 mb-1'  >ยอมรับออเดอร์</a>";
                                    echo " <a href='changecusshop1admin.php?ID_Order=$row[0]' onclick=\"return confirm('ยืนยันการยกเลิก... !!!')\" 
