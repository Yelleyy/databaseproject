    ...
    <section class="floatingBox ant-layout">
      ...
      <div class="ant-card common__customCard___3CL84 ant-card-bordered">
        ...
        <div class="ant-card-body" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.3);">
          <header class="AppBar__container___25Yqe ant-layout-header"><span>สมัครบัญชี Grab</span><span></span></header>
            ...
            <form action="register_db.php" method="post">
              <div class="AuthContent__innerContainer___2yvjH">
                ...
                <div class="VerifyPhone__container___jZVB5">
                  <div class="VerifyPhone__heading___1YlJV">โปรดกรอกข้อมูลสมัครสมาชิกของคุณ</div>
                  ...
                  <form class="grab-ui ant-form"><span class="VerifyPhone__inlineForm___2-3im">
                      <div class="ant-row grab-ui ant-form-item VerifyPhone__phoneInput___1boWe">
                        <div class="ant-col grab-ui ant-form-item-control-wrapper">
                          ...
                          <div class="grab-ui ant-form-item-control has-success"><span class="grab-ui ant-form-item-children">ชื่อ-สกุล<input placeholder="ชื่อ-สกุล" type="name" name="name" required class="grab-ui ant-input"></span></div>
                          <br>
                          ...
                          <br>
                          <div class="grab-ui ant-form-item-control has-success"><span class="grab-ui ant-form-item-children">เบอร์โทร<input placeholder="เบอร์โทร" type="tel" name="tel" pattern="[0]{1}[0-9]{9}" required class="grab-ui ant-input"></span></div>
                          <br>
                          ...
                          <br>
                          <div class="grab-ui ant-form-item-control has-success"><span class="grab-ui ant-form-item-children">วัน/เดือน/ปี เกิด <input placeholder="ว/ด/ป" type="date" name="date" required class="input"></span></div>
                        </div>
                      </div>
                    </span>
