...
include("server.php");
$sql = "SELECT * FROM customer where level ='member'";
$result = mysqli_query($con, $sql);

$ID_User = $_REQUEST["ID"];
$sql2 = "SELECT * FROM Customer WHERE ID_User = '$ID_User'";
    ...
    <aside class="main-sidebar hidden-print ">
        <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i class="bi bi-person-circle"></i><span> ผู้ใช้</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="active treeview-menu">
                                <li class="active"><a class="waves-effect waves-dark active" href="listuser.php">
                ...
                <div class="col-md-11">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ข้อมูลผู้ใช้
                            </h4>
                        </div>
                        <div class="card-body">
                                ...
                                <?php $row2 = mysqli_fetch_array($result2);?>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>ชื่อ</label>
                                            <input type="text" id="Name_User" name="Name_User" class="form-control" value=<?php echo $row2['Name_User'] ?>>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>อีเมล</label>
                                            <input type="text" id="Email_User" name="Email_User" class="form-control" value=<?php echo $row2['Email_User'] ?>>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>รหัสผ่าน</label>
                                            <input type="text" id="Pass_User" name="Pass_User" class="form-control" value=<?php echo $row2['Pass_User'] ?>>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>เบอร์โทร</label>
                                            <input type="text" id="Tel_User" name="Tel_User" class="form-control" value=<?php echo $row2['Tel_User'] ?>>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>วันเกิด</label>
                                            <input type="date" id="Tel_User" name="BDate_User" class="form-control" value=<?php echo $row2['BDate_User'] ?>>
                                        </div>
